...
public class SQLProviderContract {
    public static final String CONTENT_AUTHORITY = "com.example.felixidan.session4b.sql.provider";
    ...
    public static final class NumberEntries implements BaseColumns {
        ...
        public static final String TABLE_NAME = "nums";
